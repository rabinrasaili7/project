...
include 'classes/User.php'; // Adjusted include path
include 'classes/Post.php'; // Adjusted include path
...
{
    $msg = $_POST['search'];
    $query = mysqli_query($con, "delete from messages where id='$msg'") or die("No message Found");
    if($query){
        echo "Message no. $msg has been deleted";
    }
}
?>
<!DOCTYPE html>
