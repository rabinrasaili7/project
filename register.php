...
<body>
    ...
    <div class="top-content">
        <h1 style="font-size:35px;">Wellcome to ACS, share your moments with friends!</h1>
        <p>Sign up and start sharing your photos and updates with your friends.<a href="../homepage.html">Return to Home</a>
    ...
    <div class="wreper">
        <div class="signin-form">
            <div class="form-top-left">
                <h3 style="padding-top:10px;">Login to your Profile</h3>
    ...
    <footer>            
        <div class="footer"> 
            ...
            <p> ©2024 All Rights Reserved <BR> Website designed and developed by <strong><U>ACS</u></strong></p>
        </div>
    </footer>
