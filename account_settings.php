...
include 'classes/CustomPost.php'; // Renamed the Post class file to CustomPost.php
$msg = "";
...
if(isset($_POST['submit_cover_pic'])){
    ...
    if($imageName != ""){
        ...
        // Check file size
        if ($_FILES["cover_pic"]["size"] > 500000) {
            $uploadOk = 0;
        ...
        if($uploadOk){
            ...
            $compressed_image = compressImage($_FILES['cover_pic']['tmp_name'], $imageName, 75); // Adjust the quality as needed
        ...
        <div >
            ...
            <form action="account_settings.php" method="post"  enctype="multipart/form-data">
                ...
                <tr class="r4">
                    ...
                    <td> <input type="text" name="Fname" id="Fname"> <input type="submit" name="submit_Fname" value="Edit"> <input type="submit" style="background: darkorange;" value="Cancel">  <?php if (in_array("Fail to update First name" , $error_array)) echo "<br>Fail to update First name"; elseif (in_array("First name Updated :)" , $error_array)) { echo "<br>First name updated :)"; } 
                ?> </td>
                </tr>
                <tr><td><hr style="width: 240%;"></td></tr>
                <tr class="r5">
